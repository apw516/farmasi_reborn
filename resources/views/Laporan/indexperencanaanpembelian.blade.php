...
@section('container')
    <div class="app-content-header">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0">Perencanaan Pengadaan Barang</h3>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Perencanaan Pengadaan Barang</li>
                    </ol>
                </div>
            </div>
            <!--end::Row-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <select class="form-select" aria-label="Default select example" id="kode_tipe">
                        ...
                        <div class="col-md-2">
                            <button class="btn btn-success" style="margin-top:32px" onclick="buatrencana()"><i
                                    class="bi bi-cpu" style="margin-right:12px"></i> Buat Rencana Pengadaan</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        function buatrencana() {
            ...
            $.ajax({
                ...
                url: '<?= route('buatrencanapengadaan') ?>',
