            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Buat Resep</li>
                    </ol>
                </div>
            </div>
            <!--end::Row-->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Pilih Unit</label>
                                    <select class="form-select" aria-label="Default select example" id="kode_unit">
    ...
    <script>
        ...
        function carikunjungan() {
            ...
            $.ajax({
                ...
                url: '<?= route('ambildatakunjungan_w_unit') ?>',
