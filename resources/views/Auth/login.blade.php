...
<head>
    ...
    <title>Farmasi Reborn | Silahkan Login </title>
    ...
    <style>
        ...
        * {
        ...
        button {
            border-radius: 20px;
            border: 1px solid rgb(247, 192, 218);
        ...
        .overlay {
            ...
            background: -webkit-linear-gradient(to right, rgb(247, 192, 218), rgb(247, 192, 218));
            background: linear-gradient(to right, rgb(247, 192, 218), rgb(247, 192, 218));
        ...
        <div class="overlay-container">
            <div class="overlay">
                <div class="overlay-panel overlay-left">
                    <img src="{{ asset('/public/img/logo_rs.png') }}" alt="" width="50%"
